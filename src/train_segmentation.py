...
def main() -> None:
    ...
    parser.add_argument("aoi", type=str, required=True, choices=list(AOIs))
    parser.add_argument("labels", type=str, required=True, choices=list(LABEL_MAPS))
    parser.add_argument("model", type=str, required=True, help="Model type.", choices=list(cfg.ModelName))
    parser.add_argument("--type", type=str, default="train", help="[train, debug, overfit, ...]. Default: train")
    parser.add_argument("--loss-type", type=str, default=None, choices=list(LossType))
    parser.add_argument("--lr-scheduler", type=str, default=None, choices=list(LRSchedulerType))
